...
from cyclegan_pytorch.optim import DecayLR
from cyclegan_pytorch.models import Discriminator
from cyclegan_pytorch.models import Generator
from cyclegan_pytorch.datasets import ImageDataset
from cyclegan_pytorch.utils import ReplayBuffer
from cyclegan_pytorch.utils import weights_init
...
class class_Parser():
    def __init__(self):
        ...
        self.netD_B = ""
        self.outf = "./outputs"
        self.image_size = 256 #original (1000,3000)
...
dataset = ImageDataset(root=os.path.join(args.dataroot, args.dataset),
                       transform=transforms.Compose([
                           transforms.Resize(int(args.image_size * 1.12), InterpolationMode.BICUBIC),
